...
interface ProfileSetupWithAvatarProps {
...
const ProfileSetupWithAvatar: React.FC<ProfileSetupWithAvatarProps> = ({
  profile,
  isEditing = false,
  onProfileComplete,
  onBack,
  ...
  const [photoPath, setPhotoPath] = useState<string>(profile?.photo || '');
...
export default ProfileSetupWithAvatar; 